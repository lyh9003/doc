...
if 'user_name' in st.session_state and 'user_number' in st.session_state:
    ...
    기본 규칙:
    1. '문제'와 '정답'이 제공되었습니다. 각 번호 문제에 대해 학생의 답안과 제공된 '정답'을 반드시 정확하게 비교하여 평가해 주세요.
    2. 오답인 경우 정확히 무엇이 잘못되었는지 설명해야 하고, 정답인 경우에만 칭찬합니다.
    3. 제공된 정답 이외의 답변은 정답으로 처리하지 마세요. 오직 제시된 정답과 일치할 때만 "맞았습니다"라고 피드백을 주세요.
